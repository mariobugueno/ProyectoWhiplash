      ...
      <?php
        ...
        while ($public=mysql_fetch_array($peticionpublic)) {
          ...
          echo "    <div class='col-md-8 my-auto'>
                      <form class='login-form' action='subircomentarioadmin.php' method='post'>
                        <div class='row'>
...
<footer>
    <div class="text-center">
    	<hr>
    	<a href="index.html">&copy Whiplash Rock Cover Band.</a>
    			<a class="social" href="#"><img src="img/facebook_circle-512.png" height="30"></a>
