    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 login-sec">
          <h2 class="text-center estilotexto text-uppercase">modificar publicación</h2>
          <form class="login-form" action="confmodificarpublicacion.php" method="post">
            <input type="hidden" name="id_p" value="'.$id_.'">
            <div class="row">
              <div class="col-md-12 form-group">
                <label class="estilotexto">título</label>
                <input type="text" class="form-control" name="titulo" id="inputTitulo3" value="'.$fila['titulo'].'" placeholder="Título" required>
              </div>
              <div class="col-md-12 form-group">
                <label class="estilotexto">publicación</label>
                <textarea class="form-control" name="contenido" id="idcontenido" rows="5" required>'.$fila['contenido'].'</textarea>
              </div>
            </div>
